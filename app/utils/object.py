        ...
        if order.direction == Direction.LONG:
            ...
            if self.pos == 0:
                ...
                if previous_pos == 0:
                    ...
                    self.avg_price = (
                        previous_pos * previous_avg + order.volume * order.price) / abs(self.pos)
            ...
            if self.pos == 0:
                ...
                if previous_pos == 0:
                    ...
                    self.avg_price = (
                        abs(previous_pos) * previous_avg + order.volume * order.price) / abs(self.pos)
