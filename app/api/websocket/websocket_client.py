...
from app.utils.utility import get_file_logger
...
class WebsocketClient:
    ...
    Use stop to stop threads and disconnect websocket before destroying the client object
        ...
        try:
            while self._active:
                ...
                # for socket.error, see Issue
                    ...
                    self._disconnect()
                # other interval exception raised in on_packet
                except:
